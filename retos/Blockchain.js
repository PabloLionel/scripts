    ...
    isChainValid(){
        ...
        for (const i = 1; i < n; ++i) {
            ...
            if (currentBlock.hash !== currentBlock.calculateHash())
                return false
            if (currentBlock !== prevChain.hash)
                return false
        }
        return true
    }
...
const { log } = console
const plog = o => log(JSON.stringify(o,null,4))
const savjeeCoin = new Blockchain()
savjeeCoin.addBlock(new Block(1, '10/07/2019', { amount: 4 }))
savjeeCoin.addBlock(new Block(2, '12/07/2019', { amount: 10}))
savjeeCoin.addBlock(new Block(3, '15/08/2019', { amount: 11}))
savjeeCoin.addBlock(new Block(4, '10/09/2019', { amount: 14}))
plog(savjeeCoin)
